...
animado que mira a los cuatro lados; el piso 1 hace de tutorial con arte de musgo y el 2 de
...
└── assets/
    ├── mago/          # frames del personaje jugable (4 direcciones)
    ├── nigromante/    # personaje anterior, fuera de uso
